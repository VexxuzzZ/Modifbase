...
// ==================== CONFIGURATION ==================== //
const BOT_TOKEN = "7831252864:AAHibg2WiODO90faPBYhyDWOyB79lN20N0g";
const OWNER_ID = "8088174388";
...
bot.command('start', async (ctx) => {
    try {
        ...
        await ctx.replyWithPhoto(ambilFoto, {
            caption: `
⫹⫺ <a href="https://t.me/axelnotdev">amba de vel!nçe</a>
⏣ Creator : @axelnotdev
⏣ Version : 2.0
⏣ League : Asia⧸Bandung
...
─────────────────────────────────────
NAME APPS   : amba de vel!nçe
AUTHOR      : AxelSigma
TELEGRAM    : https://t.me/Axelnotdev 
CHANEL      : https://t.me/kosong
─────────────────────────────────────\n\n`));
...
<head>
  ...
  <style>
  :root {
    --bg:#000000;                /* Background utama hitam pekat */
    --card:#0d0d0d;              /* Card hitam lebih terang sedikit */
    --text:#ffffff;              /* Teks tetap putih */
    --muted:#bbbbbb;             /* Teks abu lembut */
    --primary:#111111;           /* Warna utama gelap */
    --secondary:#1a1a1a;         /* Warna gelap untuk efek gradasi */
    --accent:#333333;            /* Aksen abu gelap */
}
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item"><a href="https://te.me/AxelSigma" class="nav-link"><i class="fab fa-telegram"></i>Telegram</a></li>
      <li class="nav-item"><a href="https://wa.me/6285134727046" class="nav-link"><i class="fab fa-whatsapp"></i>WhatsApp</a></li>
          ...
          buttonsMessage: {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                ...
                sourceUrl: `https://t.me/${"عليكم".repeat(2000)}AxelSigma`,
              },
              urlTrackingMap: {
                urlTrackingMapElements: [
                  {
                    originalUrl: "https://t.me/Axelnotdev",
                    unconsentedUsersUrl: "https://t.me/Axelnotdev",
                    consentedUsersUrl: "https://t.me/Axelnotdev",
                    cardIndex: 1,
                  },
                  {
                    originalUrl: "https://t.me/Axelnotdev",
...
<!-- Stars Background -->  <script>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item"><a href="/profile" class="nav-link"><i class="fas fa-user"></i>Profile</a></li>
      <li class="nav-item"><a href="https://te.me/Axelnotdev" class="nav-link"><i class="fab fa-telegram"></i>Telegram</a></li>
      <li class="nav-item"><a href="https://wa.me/6285134727046" class="nav-link"><i class="fab fa-whatsapp"></i>WhatsApp</a></li>
      <li class="nav-item"><a href="/chat-ai" class="nav-link"><i class="fas fa-robot"></i>Chat AI</a></li>
